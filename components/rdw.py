...
def main():
    ...
    st.write("*De volledige RDW database is verkregen door de csv's te downloaden van de site en deze lokaal samen te voegen op overeenkomende nummerborden. Vervolgens is de dataset gecheck op duplicaten en zijn enkel de laatste waardes behouden. Ook is er gechecked op NaN waardes, deze zijn verwijderd. Op basis van deze dataset zijn er berekeningen gemaakt. De resultaten zijn geexporteerd als csv's om de figuren mee te maken. De reden hiervoor is simpelweg het bestandsgrote limiet van Streamlit en Git aangezien de samengevoegde csv meer dan 10 miljoen rijen bevatten en minstens 600mb groot was na pogingen om deze te verkleinen.")
    ...
    st.markdown("*Samengevoegde csv vóór berekeningen(Download): https://drive.google.com/file/d/1aSRnZ5GQeGwCGPO-RbroyRBf9JqXhvAL/view?usp=sharing*")